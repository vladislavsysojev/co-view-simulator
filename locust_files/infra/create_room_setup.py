...
#                     log.info("Request url: {}".format(response.request.url) + "; Response code: {}".format(
#                         response.status_code) + "; Response body: {}".format(response.content))
#                 else:
#                     log.error("Request url: {}".format(response.request.url) + "; Response code: {}".format(
#                         response.status_code) + "; Response body: {}".format(response.content))
...
#                     log.info("Room list: {}".format(common.config.rooms_list))
#                     log.info("{} rooms are available".format(len(common.config.rooms_list)))
#                     if len(common.config.rooms_list) == common.config.NUMBER_OF_ROOMS:
#                         pass
#                     else:
#                         log.error("Wrong number of rooms, please restart!")
#                     quit()
#
...
#                     quit()
#                     else:
#                     log.error("Please set the parameter DISTRIBUTED_MODE to True in common/config.py")
#                     quit()
#                     "id": common.config.CONTENT_ID,
#                             "playbackUrls": common.config.PLAYBACK_URLS
#                         },
